...
<div class="container">
	<div class="row">
		<h1 class="col-xs-12 rajdhani">NUESTRAS COLECCIONES</h1>
	...
	<div class="row">
		<div class="col-xs-12 col-md-4 collection">
			...
			<div class="view-collection">
				<a href="/wys/categoria-producto/piedras-naturales/" class="rojo1">Ver colección</a>
			</div>
		</div>
		...
		<div class="col-xs-12 col-md-4 collection">
			...
			<div class="view-collection">
				<a href="/wys/categoria-producto/maderas-de-ingenieria/" class="rojo1">Ver colección</a>
			</div>
		</div>
		...
		<div class="col-xs-12 col-md-4 collection">
			...
			<div class="view-collection">
				<a href="/wys/categoria-producto/neolith/" class="rojo1">Ver colección</a>
			</div>
		</div>
	</div>

	<div class="row">
		<p class="col-sm-10 col-sm-offset-1 m-top-60">Y por la garantía no te preocupes, nuestras marcas importadas tienen entre 15 y 20 años de respaldo y seguridad.</p>
	</div>
</div>
